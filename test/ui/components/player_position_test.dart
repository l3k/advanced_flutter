...
void main() {
  ...
  testWidgets("should handle defender position", (tester) async {
    await tester.pumpWidget(
      MaterialApp(home: PlayerPosition(position: 'defender')),
    );
  ...
  testWidgets("should handle midfielder position", (tester) async {
    await tester.pumpWidget(
      MaterialApp(home: PlayerPosition(position: 'midfielder')),
    );
    expect(find.text('Meio-campista'), findsOneWidget);
  });

  testWidgets("should handle forward position", (tester) async {
    await tester.pumpWidget(
      MaterialApp(home: PlayerPosition(position: 'forward')),
    );
